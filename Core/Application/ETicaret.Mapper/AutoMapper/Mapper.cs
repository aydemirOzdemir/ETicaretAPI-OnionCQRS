...
public class Mapper : E_Ticaret.Application.Interfaces.AutoMapper.IMapper
{
    ...
    //depth değerleri mapleme işleminde bir dtonun içinde kaç dto daha maplenebilir onuveriyor default 5
